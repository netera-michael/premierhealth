  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-primary-900 rounded-lg shadow-md p-8 text-white text-center">
          ...
          <button className="bg-white text-primary-900 px-6 py-3 rounded-tl-2xl rounded-br-2xl rounded-tr-none rounded-bl-none font-medium hover:bg-gray-100 transition-colors">
