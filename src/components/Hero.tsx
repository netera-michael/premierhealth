          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2 text-primary-600">
                ...
                <span className="font-medium">Premium Wellness Center</span>
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Revitalize Your Health with
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600"> IV Vitamin Therapy</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed">
                Experience the ultimate in wellness with our premium IV vitamin drips. 
                Boost energy, enhance immunity, and optimize your health with direct nutrient delivery.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-8 pt-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-700 font-medium">Licensed Medical Team</span>
              </div>
              <div className="flex items-center space-x-2">
